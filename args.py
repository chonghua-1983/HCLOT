...
def make_args():
    ...
    parser.add_argument('--pca_dim', dest='pca_dim', type=int, default=50, help='pca components')
    parser.add_argument('--feat_hidden1', dest='feat_hidden1', type=int, default=100, help='hidden dimension1')
    parser.add_argument('--feat_hidden2', dest='feat_hidden2', type=int, default=50, help='hidden dimension2')   
    parser.add_argument('--gcn_hidden1', dest='gcn_hidden1', type=int, default=128, help='hidden dimension1')
    parser.add_argument('--gcn_hidden2', dest='gcn_hidden2', type=int, default=64, help='hidden dimension2')
    parser.add_argument('--gcn_hidden3', dest='gcn_hidden2', type=int, default=32, help='hidden dimension3')
    parser.add_argument('--p_drop', dest='p_drop', type=int, default=0.4, help='drop rate')
    parser.add_argument('--dec_cluster_n', dest='dec_cluster_n', type=int, default=20, help='cluster number')

    # Loss settings
    parser.add_argument('--alpha', dest='alpha', type=float, default=0.9, help='weight of gw distance')
    parser.add_argument('--gw_weight', dest='gw_weight', type=float, default=0.9, help='weight of gw distance')  # 0.9
    parser.add_argument('--gamma_p', dest='gamma_p', type=float, default=1e-2, help='entropy regularization parameter') # 1e-2
